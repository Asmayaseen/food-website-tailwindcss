...
const Hero = () => {
    ...
    return (
        <div className="relative min-h-screen">
            <Image 
                className="lg:w-[480px] xl:w-[620px] h-auto absolute right-0 top-0 -z-10 " 
                src="/pexels-chevanon-323682.jpg" 
                width={1000} 
                height={600} 
                alt="hero bg"
            />
            ...
            <div className="container h-[calc(100vh-120px)] grid items-center">
                <div className="space-y-4 bg-[#ffffff98] w-fit p-4">
                    ...
                    <p className="text-gray-700 text-[14px] sm:text-[30px]">
                        Delicious food color,aroma and taste. <br />
                        What are you waiting for?
                    </p>
                    <button className="bg-accent text-white px-6 py-2 rounded-3xl text-[14px] sm:text-[30px]">View More</button>
                </div>
            </div>
        </div>
    );
